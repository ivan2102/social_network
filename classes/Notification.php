...
class Notification {
    ...
    public function insertNotification($post_id, $user_to, $type){
        ...
        $link = "post_notification.php?id=" . $post_id;

        $insert_query = mysqli_query($this->connect, "INSERT INTO notifications VALUES('','{$user_to}','{$userLoggedIn}','{$message}','{$link}','{$date_time}','no','no')");
    }
    ...
    public function getNotifications($data, $limit){
        ...
        $query = mysqli_query($this->connect, "SELECT * FROM notifications WHERE user_to='$userLoggedIn'");
