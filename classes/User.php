...
class User {
    ...
    public function getFirstAndLastName(){
        ...
        $username = $this->user['username'];
        $query = mysqli_query($this->connect, "SELECT firstName, lastName FROM users WHERE username='$username'");
        $row = mysqli_fetch_array($query);
    ...
    public function getFriendArray(){
        $username = $this->user['username'];
        $query = mysqli_query($this->connect, "SELECT friend_array FROM users WHERE username='$username'");
        $row = mysqli_fetch_array($query);
    ...
    public function sendRequest($user_to){
        $user_from = $this->user['username'];
        $query = mysqli_query($this->connect, "INSERT INTO friend_requests VALUES('','{$user_to}','{$user_from}')");
    }
