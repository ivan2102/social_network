$(document).ready(function() {
    ...
    $('#submit_profile_post').click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "handlers/ajax_submit_profile_post.php",
...
$(document).click(function(event) {
    if (event.target.class != "search_results" && event.target.id != "search_text_input") {
    ...
    if (event.target.class != "dropdown_data_window") {
...
function getLiveSearchUsers(value, user) {
    ...
    $.post("handlers/ajax_search.php", { query: value, userLoggedIn: user }, function(data) {
        ...
        $('.search_results_footer').html("<a href='search.php?query=" + value + "'>See all Results</a>");
